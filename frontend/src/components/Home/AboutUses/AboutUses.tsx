        ...
        <div className={style.about}>
            <>
                <div className={style.aboutTitle}>
                    ...
                    <div style={{ visibility: "hidden" }} className={style.projectsTitleMore}>
                        Daha çox məlumat al
                    </div>
                </div>
                ...
                <div className={style.section}>
                    ...
                    <div className={style.sectionInfo}>
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: aboutUses[0]?.content?.slice(0, 190) }}
                        />
                        <div className={style.sectionAbout}>
                            <span className={style.sectionIcon}>
                                <FaArrowRight />
                            </span>
                            <span onClick={() => navigate(ABOUT_PATH)} className={style.sectionMore}>Daha çox məlumat al</span>
                        </div>
                    </div>
