...
const Footer = () => {
  ...
  return (
    <div className={style.footer}>
      ...
      <p className={style.copyright}>Copyrighted © 2025 Neftchi SMF</p>
    </div>
  );
};
